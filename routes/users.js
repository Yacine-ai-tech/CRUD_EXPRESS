...
router.post("/",(req,res)=>{
    //Push a new user object into the users array based query parameters from the request
    users.push({
...
router.put("/:email", (req, res) => {
    ...
    if(filtered_users.length>0){
        ...
        /* 
        Include similar code here for updating other attributes
        ...
        */
        ...
        // Send success message indicating the user has
